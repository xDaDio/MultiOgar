...
function initAsClient(address, protocols, options) {
  ...
  // begin handshake
  var key = Buffer.alloc(options.value.protocolVersion + '-' + Date.now()).toString('base64');
  ...
  if (auth) {
    requestOptions.headers.Authorization = 'Basic ' + Buffer.alloc(auth).toString('base64');
  }
